...
if exist "%REPO_ROOT%app\tools\portable_launch.py" (
  "%QDF_APP_PYTHON%" "%REPO_ROOT%app\tools\portable_launch.py" --app QDFevo_2_AtlasFitter --script "%REPO_ROOT%app\QDFevo_2_AtlasFitter.py"
) else (
  "%QDF_APP_PYTHON%" "%REPO_ROOT%app\QDFevo_2_AtlasFitter.py"
)
